...
def show_predict_page():
    st.title("Used Bike Price Estimator")
    ...
    Power= (
        100, 107, 110, 125, 135, 149, 150, 160, 175, 180, 200, 220, 223, 250, 295, 300, 302, 310, 320, 350, 390, 400, 410, 500, 502, 535, 600, 650, 675, 750, 765, 796, 797, 800, 821, 850, 865, 883, 899, 900, 959, 1000, 1050, 1090, 1100, 1130, 1198, 1200, 1262, 1299, 1300, 1700, 1800
    )
    owner = (
        'First Owner',
        'Second Owner',
    ...
    kms_driven = st.number_input("Bike Driven (in Kilometer)", 0, None, 1000, None)
